                          ...
                          {reviews.length > 0 ? (
                            reviews.map((reviewed) => (
                              <div key={reviewed.id} className="review-item">
                                ...
                                {/* Show Edit and Delete buttons only if the review's userId matches the currentUser's id */}
                          ...
                          challengeDetails.map((challenge, index) => (
                            <div key={index} className="challenge-card">
                              ...
                              <div className="challenge-card-footer">
                                {challenge.challengestatus === 'open' && challenge.firstUserId !== currentUser.id && (
                                  <button
                                ...
                                {challenge.challengestatus === 'open' && challenge.firstUserId === currentUser.id && (
                                  <p className="info-message">You posted this challenge.</p>
                                )}
